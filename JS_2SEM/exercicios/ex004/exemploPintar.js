...
canvas.width = 800;
canvas.height = 600;
const context = canvas.gerContext('2d');
...
canvas.addEventListener('mouseup', () => {
    pintando = false;
    context.baginPath();//começa uma nova trajetoria.
})

//a ação e iniciada assim que o mouse se move,
...
//o event e um objeto que contem atributos que são acionados de acordo
